...
in
{
  options.modules.home.programs.helix = {
    enable = mkBoolOpt true "Enable Helix editor with comprehensive language support";
  };

  config = lib.mkIf config.modules.home.programs.helix.enable {
    programs.helix = {
      enable = true;
